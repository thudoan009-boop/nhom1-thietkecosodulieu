\chapter{Chi tiết các Thực thể Dữ liệu}

\section{Nhóm Quản trị \& Kết nối}

\subsection{User (Thực thể mạnh)}
...
\subsection{Permission (Thực thể mạnh)}
...
\subsection{RolePermission (Thực thể liên kết)}
...
\subsection{WorkspaceMember (Thực thể mối kết hợp)}
...
\subsection{GitHubConnection (Thực thể phụ thuộc)}
...
\subsection{Repository (Thực thể mạnh)}
...
\subsection{Branch (Thực thể yếu -- phụ thuộc Repository)}
...
\subsection{Commit (Thực thể yếu -- phụ thuộc Branch/Repository)}
...
\subsection{PullRequest (Thực thể yếu -- phụ thuộc Repository)}
...
\subsection{CodeDiff (Thực thể yếu -- phụ thuộc Commit/PR)}
...
\subsection{File (Thực thể yếu -- phụ thuộc Repository)}
...
\subsection{CodeEntity (Thực thể yếu -- phụ thuộc File)}
...
\subsection{Dependency (Thực thể mối kết hợp)}
...
\subsection{Template (Thực thể mạnh)}
...
\subsection{TemplateSection (Thực thể yếu -- phụ thuộc Template)}
...
\subsection{Placeholder (Thực thể yếu -- phụ thuộc TemplateSection)}
...
\subsection{TemplateMapping (Thực thể mối kết hợp)}
...
\subsection{Document (Thực thể mạnh)}
...
\subsection{DocumentVersion (Thực thể yếu -- phụ thuộc Document)}
...
\subsection{ChangeLog (Thực thể yếu -- phụ thuộc DocumentVersion)}
...
\subsection{Review (Thực thể mối kết hợp/Sự kiện)}
...
\subsection{ReviewComment (Thực thể yếu -- phụ thuộc Review)}
...
\subsection{Approval (Thực thể mối kết hợp/Sự kiện)}
...
\subsection{GroundingEvidence (Thực thể yếu -- phụ thuộc DocumentVersion)}
...
\subsection{DriftAlert (Thực thể sự kiện)}
