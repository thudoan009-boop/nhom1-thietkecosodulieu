\subsection{nh Xạ Lược Đồ ER Phân Hệ Kiểm Duyệt, Bằng Chứng AI \& Giám Sát Hệ Thống (Governance, AI Evidence \& Observability Domain)}

\
\subsubsection{Mã DDL SQL Hoàn Chỉnh (\texttt{schema\_member\_5.sql})}
