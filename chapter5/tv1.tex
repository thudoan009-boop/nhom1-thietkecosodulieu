\section{Ánh Xạ Lược Đồ ER }
\subsection{Phân Hệ Quản Trị Xác Thực \& Phân Quyền (Auth \& RBAC Domain)}
\noindent\rule{\linewidth}{0.5pt}

\subsubsection{Mã DDL SQL Hoàn Chỉnh (\texttt{schema\_member\_1.sql})}
